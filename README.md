...
This repository consists of main 5 folders:
...
- ## 4- web_ui: (React-Web dashboard that add some features such as)
    - Robot connection status.
    - Moving buttons in various directions.
    - Force stop button for emergency cases.
    - Displaying and Tracking current distance between camera and Apriltag

<br />

- ## 5- simulation: (Gazebo simulation of Apriltag following process)
    - **bittle_description**: This package includes bittle urdf model.
    - **bittle_gazebo**: This package used for spawning bittle robot.
    - **apriltag_pose_estimation**: This package is used to estimate and publish the current distance between camera and Apriltag.
    - **apriltag_follower**: the main package in which Apriltag detection process is implemented 
<br />
...
1.  installation
    - 
    ~~~bash
    $ cd construction-robotics-ws-2022_23/web_ui/
    $ npm inistall
    ~~~
    
2.  edit the websocket ip
    -
    ~~~bash
    $ cd construction-robotics-ws-2022_23/web_ui/src/features/RosConnection 
    $ ifconfig` # to get the local ip address of your device
    $ cat RosConnectionSlice.js
    $ edit  `const rosbridge_address ="your_ip"
    ~~~

3.  open websocket connection to the local running roscore
    -
    ~~~bash
...
<p align="center">
<img  src="./assets/dist_cam_web.gif" />
</p>
